...
export default function AddListButton() {
    ...
    return (/*<Button className="new-list-button">{'ایجاد لیست جدید +'}</Button>*/
        <div className="fixed bottom-4 right-4 z-50 flex items-center gap-2">
            <button id="floating-btn"  className="bg-gray-800 hover:bg-gray-700 text-white dark:bg-gray-100 dark:hover:bg-gray-200 dark:text-gray-900 text-xl p-4 rounded-full shadow-lg" >
                +
            </button>
